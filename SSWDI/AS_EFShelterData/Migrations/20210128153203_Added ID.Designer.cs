...
namespace AS_EFShelterData.Migrations
{
    ...
    [Migration("20210128153203_Added ID")]
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Content = "Cool doggo",
                            Date = new DateTime(2021, 1, 28, 16, 32, 2, 325, DateTimeKind.Local).AddTicks(4978),
                            StayID = 1,
                            WrittenBy = "Barry"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 1, 28, 16, 32, 2, 329, DateTimeKind.Local).AddTicks(489),
                            StayID = 2,
                            WrittenBy = "Barry"
                        });
                });
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Treatment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 28, 16, 32, 2, 329, DateTimeKind.Local).AddTicks(5426),
                        ...
                        new
                        {
                            ID = 2,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 28, 16, 32, 2, 329, DateTimeKind.Local).AddTicks(6803),
