...
namespace AS_EFShelterData.Migrations
{
    ...
    [Migration("20210124121641_Gender update")]
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Animal", b =>
                {
                    ...
                    b.Property<string>("InterestedUser")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Content = "Cool doggo",
                            Date = new DateTime(2021, 1, 24, 13, 16, 40, 937, DateTimeKind.Local).AddTicks(9792),
                            StayID = 1,
                            WrittenBy = "Barry"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 1, 24, 13, 16, 40, 942, DateTimeKind.Local).AddTicks(1192),
                            StayID = 2,
                            WrittenBy = "Barry"
                        });
                });
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Treatment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 24, 13, 16, 40, 942, DateTimeKind.Local).AddTicks(6440),
                        ...
                        new
                        {
                            ID = 2,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 24, 13, 16, 40, 942, DateTimeKind.Local).AddTicks(7736),
