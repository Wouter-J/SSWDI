...
namespace AS_EFShelterData.Migrations
{
    ...
    [Migration("20210128142920_Added ManyToMany table")]
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Content = "Cool doggo",
                            Date = new DateTime(2021, 1, 28, 15, 29, 19, 239, DateTimeKind.Local).AddTicks(197),
                            StayID = 1,
                            WrittenBy = "Barry"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 1, 28, 15, 29, 19, 243, DateTimeKind.Local).AddTicks(2975),
                            StayID = 2,
                            WrittenBy = "Barry"
                        });
                });
            ...
            modelBuilder.Entity("AS_Core.DomainModel.Treatment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 28, 15, 29, 19, 243, DateTimeKind.Local).AddTicks(8129),
                        ...
                        new
                        {
                            ID = 2,
                            Costs = 100,
                            Date = new DateTime(2021, 1, 28, 15, 29, 19, 243, DateTimeKind.Local).AddTicks(9408),
